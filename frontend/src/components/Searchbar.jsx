...
//         `/api/search/doctor?name=${query}&discipline=${filters.discipline}&experience=${filters.experience}&degree=${filters.degree}`
//       );
//       setDoctors(data);
//     } catch (error) {
...
const Searchbar = () => {
  ...
  const handleDoctorClick = async (doctorId) => {
    try {
      const { data } = await axios.post(`/api/message/user/makechat`, {
        userId: doctorId,
      });
